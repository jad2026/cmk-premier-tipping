      ...
      <section style={{ background: "#F2F0EA" }}>
        <div className="mx-auto" style={{ maxWidth: 1100, padding: "28px 32px 60px" }}>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="rounded-2xl bg-white border border-[#E4E1D8]" style={{ padding: 24 }}>
                <div className="h-4 w-32 rounded bg-[#E4E1D8] animate-pulse mb-3" />
                <div className="h-3 w-48 rounded bg-[#E4E1D8] animate-pulse" />
              </div>
            ))}
          </div>
        </div>
