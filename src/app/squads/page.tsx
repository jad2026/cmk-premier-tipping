    ...
    >
      ...
      <section style={{ background: "#0B0E13", minHeight: "60vh" }}>
        <div className="mx-auto" style={{ maxWidth: 1100, padding: "30px 32px 70px" }}>
          {teamList.length === 0 ? (
            <div style={{ textAlign: "center", padding: "60px 24px", color: "rgba(255,255,255,.4)", fontSize: 15, fontStyle: "italic" }}>
              ...
              {teamList.map((team) => {
                ...
                return (
                  <Link
                    ...
                    href={`/squads/${team.id}`}
                    style={{
                      background: `linear-gradient(160deg, ${team.colour}30 0%, #161A22 70%)`,
                      borderRadius: 14,
                      overflow: "hidden",
                      display: "flex",
